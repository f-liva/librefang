...
describe('ownerIntentsRelay', () => {
  ...
  it('returns true for explicit /relay command', () => {
  ...
  it('does not match partial words', () => {
    // "rispondigli" isn't in the verb list on purpose — explicit verbs only
    assert.equal(ownerIntentsRelay('salutami la zia'), false); // "salutami" ≠ "saluta"
